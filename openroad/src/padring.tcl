...
place_pad -row IO_SOUTH -location [expr {$southStart +  2*$southPitch}] "pad_unused2_o"     ; # pin no:  3
...
place_pad -row IO_SOUTH -location [expr {$southStart + 15*$southPitch}] "pad_wdata_12_i"    ; # pin no: 16
...
place_pad -row IO_NORTH -location [expr {$northStart -  2*$northPitch}] "pad_unused3_o"     ; # pin no:  3
...
place_pad -row IO_NORTH -location [expr {$northStart - 15*$northPitch}] "pad_rdata_15_o"    ; # pin no: 16
