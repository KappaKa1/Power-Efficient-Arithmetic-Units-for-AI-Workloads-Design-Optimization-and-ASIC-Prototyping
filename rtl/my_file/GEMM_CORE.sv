...
module GEMM_CORE #(
  ...
  parameter string MATMUL_TYPE = "TC_Best_Power"
)(
  input logic 				clk_i,
  input logic 				rst_ni,
  ...
  generate
  ...
  end else if (MATMUL_TYPE == "SM_Best_Power") begin : gen_sm_power
    matmul_4x4x4_int4_cw13_accum_hc_sm_no_enc_350mhz u_matmul(
      .a_0_0(operand_A_q[3:0]),      .a_0_1(operand_A_q[7:4]),      .a_0_2(operand_A_q[11:8]),     .a_0_3(operand_A_q[15:12]),
      .a_1_0(operand_A_q[19:16]),    .a_1_1(operand_A_q[23:20]),    .a_1_2(operand_A_q[27:24]),    .a_1_3(operand_A_q[31:28]),
      .a_2_0(operand_A_q[35:32]),    .a_2_1(operand_A_q[39:36]),    .a_2_2(operand_A_q[43:40]),    .a_2_3(operand_A_q[47:44]),
      .a_3_0(operand_A_q[51:48]),    .a_3_1(operand_A_q[55:52]),    .a_3_2(operand_A_q[59:56]),    .a_3_3(operand_A_q[63:60]),
  ...
  end else if (MATMUL_TYPE == "SM_Best_Area") begin : gen_sm_area
    ...
    matmul_4x4x4_int4_cw13_cst_rca_sm_no_enc_350mhz u_matmul(
      ...
      initial begin
        $error("Unsupported MATMUL_TYPE: %s", MATMUL_TYPE);
      end
    end
  endgenerate
